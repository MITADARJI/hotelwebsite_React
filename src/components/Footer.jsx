  ...
  return (
    <div>
        ...
        <div class="footer-widgets-wrapper">
            <div class="shape1 float-bob-y d-none d-xxl-block"><img src="img/shape/footerShape1_1.png"
                    alt="shape"/></div>
            <div class="shape2 d-none d-xxl-block"><img src="img/shape/footerShape1_2.png" alt="shape"/></div>
            <div class="shape3 d-none d-xxl-block"><img src="img/shape/footerShape1_3.png" alt="shape"/></div>
            <div class="shape4  d-none d-xxl-block"><img src="img/shape/footerShape1_4.png" alt="shape"/></div>
            <div class="container">
                <div class="footer-top">
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-4 d-flex justify-content-start justify-content-lg-end">
                            <div class="fancy-box">
                                <div class="item1"><i class="fa-solid fa-phone-volume"></i></div>
                                <div class="item2">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                        <div class="single-footer-widget">
                            <div class="widget-head">
                                <a href="index.html">
                                    <img src="img/logo/logoWhite.svg" alt="logo-img"/>
                                </a>
                            </div>
