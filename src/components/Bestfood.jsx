    ...
    <div>
      <section className='best-food-items-section fix section-padding bg-color2'>
        <div className='best-food-wrapper'>
          <div className='shape1 float-bob-y  d-xxl-block'>
            <img src='img/shape/bestFoodItemsShape1_1.png' alt='shape' />
          </div>
          <div className='shape2 float-bob-x  d-xxl-block'>
            <img src='img/shape/bestFoodItemsShape1_2.png' alt='shape' />
          </div>
          <div className='container'>
            <div className='title-area'>
              ...
              >
                ...
                Best Food
                <img src='img/icon/titleIcon.svg' alt='icon' />
              </div>
              ...
              <div className='swiper bestFoodItems-slider'>
                <div className='swiper-wrapper'>
                  <div className='swiper-slide'>
                    <div className='single-food-items'>
                      <div className='item-thumb'>
                        <img src='img/food-items/item1_1.png' alt='thumb' />
                  ...
                  <div className='swiper-slide'>
                    <div className='single-food-items'>
                      <div className='item-thumb'>
                        <img src='img/food-items/item1_2.png' alt='thumb' />
                        <div className='circle-shape'>
                          <img
                            className='cir36'
                            src='img/food-items/circleShape.png'
                  ...
                  <div className='swiper-slide'>
                    <div className='single-food-items'>
                      <div className='item-thumb'>
                        <img src='img/food-items/item1_3.png' alt='thumb' />
                        <div className='circle-shape'>
                          <img
                            className='cir36'
                            src='img/food-items/circleShape.png'
                  ...
                  <div className='swiper-slide'>
                    <div className='single-food-items'>
                      <div className='item-thumb'>
                        <img src='img/food-items/item1_4.png' alt='thumb' />
                        <div className='circle-shape'>
                          <img
                            className='cir36'
                            src='img/food-items/circleShape.png'
